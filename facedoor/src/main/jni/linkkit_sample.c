...
#else
    #define IOTX_PRODUCT_KEY        "a10aPmXqfcw"
    #define IOTX_DEVICE_NAME        "tingyi.pc@alibaba-inc.com"
    #define IOTX_DEVICE_SECRET      "9LX4AJOexo7DcK0Xg8tufPwMKGRgr50g"
#endif
...
int main(int argc, char* argv[])
{
    ...
    int get_tsl_from_cloud = 1;    /* 1:自动获取  0:从TSL_STRING中获取 */
    int exit = 0;
    ...
    while (1) {
        ...
        if (now > 60 * execution_time) exit = 0;
